...
import { Box, Button, Dialog, DialogTitle, DialogContent, DialogActions, Paper, Table, TableBody, TableCell, TableRow, Alert, TableContainer } from '@mui/material';
      ...
      <>
         <Box style={{ width: 'fit-content' }}>
            ...
            <Dialog open={isConfirmationOpen} onClose={handleCancel}>
               ...
               <DialogContent style={{ color: 'red', fontWeight: 'bold' }}>Caution: If the user has entered any data, it is recommended to deactivate the user rather than delete them.</DialogContent>
