...
writeOffsRouter
  .route('/createWriteOffs/:accountID/:userID')
  // .all(requireAuth)
...
writeOffsRouter
  .route('/getActiveWriteOffs/:accountID')
  // .all(requireAuth)
  .get(async (req, res) => {
    const db = req.app.get('db');
...
writeOffsRouter
  .route('/getSingleWriteOff/:writeOffID/:accountID/:userID')
  // .all(requireAuth)
  .get(async (req, res) => {
    const db = req.app.get('db');
...
// update a writeOff
writeOffsRouter
  .route('/updateWriteOffs/:accountID/:userID')
  // .all(requireAuth)
...
// delete a writeOff
writeOffsRouter
  .route('/deleteWriteOffs/:accountID/:userID')
  // .all(requireAuth)
