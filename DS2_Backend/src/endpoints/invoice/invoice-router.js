...
// GET all invoices
invoiceRouter
  .route('/getInvoices/:accountID/:invoiceID')
  // .all(requireAuth)
  .get(async (req, res) => {
...
invoiceRouter
  .route('/createInvoice/AccountsWithBalance/:accountID/:invoiceID')
  // .all(requireAuth)
  .get(async (req, res) => {
    const db = req.app.get('db');
    const { accountID } = req.params;
...
invoiceRouter
  .route('/createInvoice/:accountID/:userID')
  // .all(requireAuth)
...
invoiceRouter
  .route('/getZippedInvoices/:accountID/:userID')
  // .all(requireAuth) // Authentication middleware
  .get(async (req, res) => {
