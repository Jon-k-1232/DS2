...
const createBillToSection = (doc, invoiceDetails, preferenceSettings) => {
  const { dueDate, customerContactInfo } = invoiceDetails;
  const { customer_street, customer_city, customer_state, customer_zip, customer_phone, invoiceRecipientName } = customerContactInfo;
