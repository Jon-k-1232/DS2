const createPdfHeader = (doc, invoiceDetails, preferenceSettings) => {
   const { invoiceNumber, accountBillingInformation } = invoiceDetails;
   ...
   doc.font(normalFont)
      ...
      .text(`Phone: ${account_phone} `, alignRight(`Email: ${account_email}`, 1), headerHeight + 45, emailWidth + doc.widthOfString('Email: '))
      .text(`Email: ${account_email}`, alignRight(`Email: ${account_email}`, 1), headerHeight + 65, emailWidth + doc.widthOfString('Email: '));
